...
#SBATCH --job-name=disk-sph-test ## When you run squeue -u
...
# configure problem
python ../../configure.py --prob=disk --coord=spherical_polar --eos=isothermal -hdf5 -h5double -mpi --hdf5_path /hpc/software/spack_v20d1/spack/opt/spack/linux-rhel7-x86_64/intel-2021.4.0/hdf5-1.10.7-exmishiaff3ugqbeeimkqvnwrir76sxh -omp --cflag=-qno-openmp-simd
make clean
make -j 4

# run the sim
mpiexec -n ${SLURM_NTASKS} ../../bin/athena -i athinput.disk_cyl
